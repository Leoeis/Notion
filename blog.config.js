...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Leoeis Laleis', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '诗人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-5j8r.vercel.app/', // 网站地址
